...
const { checkStartupApproval } = require("../middleware/approval.middleware");

router.post("/create-job", tokenMiddleware, checkStartupApproval, checkUsageLimit("maxActiveJobs"), jobController.createJob);
